...
use wgpu::{
    ...
    Operations, RenderPassDepthStencilAttachment, ShaderModuleDescriptor, ShaderSource, ShaderStage,
    StencilState, SwapChainDescriptor, TextureDescriptor, TextureFormat, TextureUsage, TextureView,
